...
define( 'ICEY_GT_VERSION', '1.0.20' );

add_filter( 'plugin_locale', 'icey_gt_force_locale', 10, 2 );
function icey_gt_force_locale( $locale, $domain ) {
    if ( 'icey-for-google-translate' === $domain ) {
        return 'sv_SE';
    }
    return $locale;
}
